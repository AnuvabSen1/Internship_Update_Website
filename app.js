...
var class_li  =['list_international list_dsp_none','list_national list_dsp_none','list_research list_dsp_none','list_software list_dsp_none'];
...
var class_li  =['list_international list_dsp_true','list_national list_dsp_true','list_research list_dsp_true','list_software list_dsp_true'];
...
if(t % 2 == 0){
 document.querySelector('.cont_crear_new').className = "cont_crear_new cont_crear_new_active";
  ...
  document.querySelector('.cont_add_cont').className = "cont_add_cont cont_add_titulo_cont_active";
  t++;
}else {  document.querySelector('.cont_crear_new').className = "cont_crear_new";
document.querySelector('.cont_add_cont').className = "cont_add_cont";
  t++;
  }
}
